...
pixi add cuda-culibos-static
# for installing globally
pixi global install cuda-culibos-static
```
...
It is possible to list all of the versions of `cuda-culibos-static` available on your platform:
...
```
pixi search cuda-culibos-static --channel conda-forge
```
